...
public class Day11 : IPuzzle
{
    ...
    public string Part1()
    {
        ...
        foreach (var pair in galaxyPairs)
        {
            ...
            var yDistance = yPath.Select(x => expandedRows.Contains(x) ? 2 : 1).Sum();
            ...
            var xDistance = xPath.Select(x => expandedCols.Contains(x) ? 2 : 1).Sum();
    ...
    public string Part2()
    {
        ...
        foreach (var pair in galaxyPairs)
        {
            ...
            var yPath = Enumerable.Range(start, end - start);
            var yDistance = yPath.Select(x => expandedRows.Contains(x) ? 1000000 : 1).Sum();
            ...
            var xPath = Enumerable.Range(start, end - start);
            var xDistance = xPath.Select(x => expandedCols.Contains(x) ? 1000000 : 1).Sum();
